...
/* HERO IMAGE */
import hero from "../assets/products/stainless-steel/changing-room-cubicle.jpg";
...
export default function ChangingRoomCubicle() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-4 pt-6 pb-16 lg:pt-16 grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            Premium changing room cubicles designed for malls, retail stores,
            gyms and sports facilities. Ensures privacy, strength and smooth
            operation in high-footfall areas. Available in multiple finishes
            with robust fittings for long-term commercial use.
          </p>
        </motion.div>
      </section>

      {/* ================= SPECIFICATIONS (MOBILE SAME AS IMAGE) ================= */}
