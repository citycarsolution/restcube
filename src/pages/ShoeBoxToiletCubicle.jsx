...
/* HERO IMAGE */
import hero from "../assets/products/stainless-steel/shoe-box-cubicle.jpg";
...
export default function ShoeBoxToiletCubicle() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-4 pt-6 pb-16 lg:pt-16 grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-extrabold mb-4">
            Shoe Box Toilet Cubicle
          </h1>

          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            Modern shoe box type toilet cubicles with elegant finish. Designed
            for malls, offices, airports and premium commercial washrooms.
            Available in 12mm & 18mm panels with heavy-duty stainless steel
            hardware.
          </p>
        </motion.div>
      </section>
