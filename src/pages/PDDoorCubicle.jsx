...
/* HERO IMAGE */
import hero from "../assets/products/stainless-steel/pd-door-cubicle.jpg";
...
export default function PDDoorCubicle() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-4 pt-6 pb-16 lg:pt-16 grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            Innovative PD door toilet cubicle system replacing traditional brick
            partitions. Ideal for space-saving washroom designs in offices,
            airports and commercial buildings. Provides faster installation,
            modern look and superior durability with stainless steel fittings.
          </p>
        </motion.div>
      </section>
