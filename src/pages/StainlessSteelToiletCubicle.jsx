...
/* HERO IMAGE */
import hero from "../assets/products/stainless-steel/hero.jpg";

/* HARDWARE */
import leg from "../assets/products/stainless-steel/leg.webp";
import hinge from "../assets/products/stainless-steel/hinge.webp";
import lock from "../assets/products/stainless-steel/lock.webp";
import knob from "../assets/products/stainless-steel/knob.webp";
import hook from "../assets/products/stainless-steel/hook.webp";
import rail from "../assets/products/stainless-steel/rail.webp";
...
export default function StainlessSteelToiletCubicle() {
  return (
    <main className="bg-gradient-to-b from-[#f2f4f7] to-white">
      ...
      <section className="max-w-7xl mx-auto px-4 pt-6 pb-16 lg:pt-16 grid lg:grid-cols-2 gap-10 items-center">
        <motion.img
          src={hero}
          alt="Stainless Steel Toilet Cubicle"
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            Premium stainless steel toilet cubicles engineered for malls,
            airports, hospitals and high-traffic commercial washrooms.
            Designed for hygiene, durability and luxury aesthetics.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-8">
            ...
            <Spec label="Hardware Material" value="Nylon Coated SS" />
            <Spec label="Sections" value="Black Anodized Aluminium" />
            <Spec label="Color Options" value="Any Custom Shade" />
            <Spec label="Surface Finish" value="Suede / Wood / Matte" />
            <Spec label="Glue" value="Melamine" />
            <Spec label="Application" value="Commercial & Public Washrooms" />
            <Spec
              label="Key Features"
              value="Waterproof, Fire-Resistant, Eco-Safe"
            />
          </div>
        </div>
      </section>
