...
/* HERO IMAGE */
import hero from "../assets/products/stainless-steel/Smokey Grey Nylon 2 copy.jpg";
...
export default function NylonToiletCubicle() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-4 pt-6 pb-16 lg:pt-16 grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-extrabold mb-4">
            Nylon Toilet Cubicle
          </h1>

          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            High-performance nylon toilet cubicle systems engineered for
            moisture-prone environments. Perfect for schools, hospitals, gyms
            and public washrooms with high usage. Lightweight,
            corrosion-resistant and cost-effective cubicles offering long-term
