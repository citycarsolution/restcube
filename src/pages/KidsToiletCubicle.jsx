...
/* HERO IMAGE */
import hero from "../assets/products/stainless-steel/kids-toilet-cubicle.jpg";
...
export default function KidsToiletCubicle() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-4 pt-6 pb-16 lg:pt-16 grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            Safe and colourful kids toilet cubicles specially designed for
            schools, play areas and child-friendly washrooms. Rounded edges,
            attractive colours and hygienic materials ensure safety and comfort
            for children. Built with durable panels and easy-to-maintain
            hardware.
          </p>
        </motion.div>
      </section>
